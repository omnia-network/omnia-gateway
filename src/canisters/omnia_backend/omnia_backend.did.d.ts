...
export type Result = { 'Ok' : EnvironmentCreationResult } |
  { 'Err' : string };
export type Result_1 = { 'Ok' : Array<InitializedGatewayValue> } |
  { 'Err' : string };
export type Result_2 = { 'Ok' : VirtualPersonaValue } |
  { 'Err' : string };
export type Result_3 = { 'Ok' : Array<string> } |
  { 'Err' : string };
export type Result_4 = { 'Ok' : Array<RegisteredGatewayValue> } |
  { 'Err' : string };
export type Result_5 = { 'Ok' : string } |
  { 'Err' : string };
export type Result_6 = { 'Ok' : UpdateValue } |
  { 'Err' : string };
export type Result_7 = {
    'Ok' : [RegisteredDeviceIndex, RegisteredDeviceValue]
  } |
  { 'Err' : string };
export type Result_8 = { 'Ok' : RegisteredGatewayValue } |
  { 'Err' : string };
export type Result_9 = { 'Ok' : EnvironmentInfo } |
  { 'Err' : string };
