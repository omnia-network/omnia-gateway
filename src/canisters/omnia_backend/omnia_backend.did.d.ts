...
export type Result = { 'Ok' : EnvironmentCreationResult } |
  { 'Err' : string };
export type Result_1 = { 'Ok' : DevicesAccessInfo } |
  { 'Err' : string };
export type Result_10 = { 'Ok' : EnvironmentInfo } |
  { 'Err' : string };
...
export type Result_7 = { 'Ok' : UpdateValue } |
  { 'Err' : string };
export type Result_8 = { 'Ok' : RegisteredDeviceIndex } |
  { 'Err' : string };
...
export interface _SERVICE {
  ...
  'getDevicesInEnvironmentByAffordance' : ActorMethod<
    [string, string],
    Result_1
  >,
