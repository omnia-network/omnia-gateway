...
export type RejectedAccessKeyReason =
  | { InvalidNonce: null }
...
export type Result_1 = { Ok: Uint8Array | number[] } | { Err: string };
export type Result_10 = { Ok: Array<RejectedAccessKey> } | { Err: string };
export type Result_11 = { Ok: EnvironmentInfo } | { Err: string };
...
export interface UniqueAccessKey {
  key: string;
  nonce: bigint;
}
